// Hafif, bağımlılıksız ikon seti (stroke tabanlı, currentColor kullanır).
...
export const IconReport = (p: P) => (
  <svg {...base(p)}>
    ...
    <path d="M14 2v6h6M8 13h2v5H8zM14 11h2v7h-2z" />
  </svg>
);
...
export const IconRadio = (p: P) => (
  <svg {...base(p)}>
    <path d="M4 9v10a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1V8a1 1 0 0 0-1-1H8" />
    <path d="m16 3-8 4" />
